...
### Alacaklılar senkronu

- **Alacaklılar** sayfasındaki kayıtlar `alacaklilar` tablosunda tutulur
- Ekle / sil işlemleri anında Supabase'e yazılır
- Başka cihazda aynı liste Realtime ile güncellenir
- Daha önce tarayıcıda kalan yerel alacaklı kayıtları ilk bağlantıda otomatik buluta taşınır
