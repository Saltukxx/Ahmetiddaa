...
borclular
  id             → uuid (kişi başına tek kayıt)
  isim           → borçlu adı
  bakiye         → güncel borç tutarı
  hareketler     → borc_al / borc_ekle / odeme geçmişi (jsonb)
```
...
- **Borçlular** sayfasında kişi başına borç bakiyesi tutulur
- **Borç Al** yeni borçlu açar; aynı isim varsa borç ekler
- **Borç Ekle** ve **Ödeme Al** ile bakiye artırılıp azaltılır
- Hareket geçmişi Supabase'de saklanır, tüm cihazlarda senkron olur
